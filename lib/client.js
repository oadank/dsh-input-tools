      ...
      return h("div", { style: { display: "flex", flexDirection: "column", gap: "14px", padding: "16px", width: "100%", boxSizing: "border-box" } },
        ...
        visionEditKey !== null ? h("div", {
          ...
          h("div", { style: {
            ...
            h("textarea", {
              // [2026-08-22] 预填当前有效提示词：用户配置优先，否则内置默认（编辑框不再空白）
              value: ((config?.vision?.prompts ?? {})[visionEditKey] ?? "").trim() !== ""
                ? (config?.vision?.prompts ?? {})[visionEditKey]
                : (visionDefaults ?? {})[visionEditKey] ?? "",
